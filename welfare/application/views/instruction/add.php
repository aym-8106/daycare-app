            ...
            <div class="col-md-8">
              <!-- general form elements -->
                ...
                <div class="box box-primary">
                    ...
                    <?php $isEdit = !empty($instruction); ?>

                    <form role="form" id="addUser" action="<?php echo base_url() ?>instruction/instruction_save" method="post">
                            ...
                            <div class="row">
                                        ...
                                        <select class="form-control required" id="post_patient" name="patientId">
                                            ...
                                            <?php foreach ($patient as $key => $value): ?>
                                                <option value="<?= $value['id'] ?>"
                                                    <?= $isEdit && $instruction['patient_id'] == $value['id'] ? 'selected' : '' ?>>
                                                    <?= $value['patient_name'] ?>
                                                </option>
                                            <?php endforeach; ?>
                                        </select>
                                        ...
                                        <select class="form-control required" id="company" name="company">
                                            ...
                                            <?php foreach ($company as $key => $value): ?>
                                                <option value="<?= $value['company_id'] ?>"
                                                    <?= $isEdit && $instruction['company_id'] == $value['company_id'] ? 'selected' : '' ?>>
                                                    <?= $value['company_name'] ?>
                                                </option>
                                            <?php endforeach; ?>
                                        </select>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control required" id="staff" name="staff">
                                            <option value="">選択してください</option>
                                            <?php if ($isEdit && !empty($staffList)): ?>
                                                <?php foreach ($staffList as $staff): ?>
                                                    <option value="<?= $staff['staff_id'] ?>"
                                                        <?= $instruction['staff_id'] == $staff['staff_id'] ? 'selected' : '' ?>>
                                                        <?= $staff['staff_name'] ?>
                                                    </option>
                                                <?php endforeach; ?>
                                            <?php endif; ?>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="patient_usefrom" name="patient_usefrom" readonly
                                            class="datepicker form-control required"
                                            value="<?= $isEdit ? $instruction['instruction_start'] : date('Y-m-d') ?>">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="patient_useto" name="patient_useto" readonly
                                            class="datepicker form-control required"
                                            value="<?= $isEdit ? $instruction['instruction_end'] : date('Y-m-t') ?>">
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="box-footer">
                            ...
                            <a class="btn btn-default" href="<?= base_url().'instruction/index/' ?>">戻る</a>
                        </div>
                    </form>
                </div>
            </div>
