            ...
            <div class="col-md-8">
              <!-- general form elements -->
                ...
                <div class="box box-primary">
                    ...
                    <form role="form" id="addUser" action="<?php echo base_url() ?>company/company/add" method="post" role="form">
                        <input type="hidden" name="mode" value="save">
                        <div class="box-body">
                            <div class="row">
                                <div class="col-md-6">                                
                                    <div class="form-group">
                                        <label for="company_name">スタッフ名：</label>
                        ...
                        <div class="box-footer">
                            ...
                            <a class="btn btn-default" href="<?php echo admin_url().'company/company/'?>">戻る</a>
                        </div>
                    </form>
                </div>
            </div>
