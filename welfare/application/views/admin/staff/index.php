        ...
        <div class="row">
            <div class="col-xs-12 text-right">
                <div class="form-group">
                    <a class="btn btn-primary" href="<?php echo admin_url(); ?>staff/add"><i class="fa fa-plus"></i>追加</a>
                </div>
            </div>
        </div>
        <div class="row">
            ...
            <div class="col-xs-12">
              <div class="box">
                <div class="box-header">
                    ...
                    <div class="box-tools">
                        <form action="<?php echo admin_url() ?>staff" method="POST" id="searchList">
                ...
                <div class="box-body table-responsive no-padding">
                  ...
                  <table class="table table-hover">
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="<?php echo admin_url().'staff/edit/'.$record['staff_id']; ?>" title="">
                        ...
                        <td class="text-center">
                            <a class="btn btn-sm btn-primary" href="<?= admin_url().'history/index/'.$record['staff_id']; ?>" title="ログイン履歴"><i class="fa fa-history"></i></a> |
                            <a class="btn btn-sm btn-info" href="<?php echo admin_url().'staff/edit/'.$record['staff_id']; ?>" title="編集"><i class="fa fa-pencil"></i></a>
