...
class History extends CompanyController
{
    /**
    ...
    public function index($company_id = NULL)
    {
        ...
        $returns = $this->_paginationCompress("company/history/index/" . $company_id . "/", $this->data['list_cnt'], 10, 5);

        $this->data['list'] = $this->company_model->loginHistory($this->data['search'], false, $returns["page"], $returns["segment"]);

        $this->_load_view_company("company/history/index");
    }
