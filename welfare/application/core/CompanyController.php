 ...
 */
class CompanyController extends WixController
{
    public $data;
    public $header;
    public $footer;
    ...
    function _load_view_company($viewName = "")
    {
        $this->load->view('company/includes/header', $this->header);
        $this->load->view($viewName, $this->data);
        $this->load->view('company/includes/footer', $this->footer);
    }
