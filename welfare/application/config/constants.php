...
define('EMAIL_FROM',                          'noreply@welfare.jp');		// e.g. email@example.com
define('EMAIL_BCC',                            	'');		// e.g. email@example.com
define('FROM_NAME',                          'CareNavi訪問看護');	// Your system name
...
define('UPLOAD_PATH',                            dirname(BASEPATH).'/assets/upload/');
//Wix Answer API
